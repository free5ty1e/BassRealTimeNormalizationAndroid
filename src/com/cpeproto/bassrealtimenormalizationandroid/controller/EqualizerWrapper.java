package com.cpeproto.bassrealtimenormalizationandroid.controller;
...
public class EqualizerWrapper
{
  ...
  public short getBand(int frequency)
  {
    ...
    try
    {
      return (Short) mEqualizer.getClass().getMethod("getBand", new Class[]
      { int.class })
  ...
  public int[] getBandFreqRange(short band)
  {
    ...
    try
    {
      return (int[]) mEqualizer.getClass()
          .getMethod("getBandFreqRange", new Class[]
          { short.class })
          .invoke(mEqualizer, new Object[]
          { band });
    }
  ...
  public short getBandLevel(short band)
  {
    ...
    try
    {
      return (Short) mEqualizer.getClass()
          .getMethod("getBandLevel", new Class[]
          { short.class })
          .invoke(mEqualizer, new Object[]
          { band });
    }
  ...
  public int getCenterFreq(short band)
  {
    ...
    try
    {
      return (Integer) mEqualizer.getClass()
          .getMethod("getCenterFreq", new Class[]
          { short.class })
          .invoke(mEqualizer, new Object[]
          { band });
    }
  ...
  public String getPresetName(short preset)
  {
    ...
    try
    {
      return (String) mEqualizer.getClass()
          .getMethod("getPresetName", new Class[]
          { short.class })
          .invoke(mEqualizer, new Object[]
          { preset });
    }
  ...
  public void setBandLevel(short band, short level)
  {
    ...
    {
      mEqualizer.getClass()
          .getMethod("setBandLevel", new Class[]
  ...
  public int setEnabled(boolean enabled)
  {
    ...
    {
      return (Integer) mEqualizer.getClass()
          .getMethod("setEnabled", new Class[]
          { boolean.class })
          .invoke(mEqualizer, new Object[]
          { enabled });
    }
  ...
  public void usePreset(short preset)
  {
    ...
    try
    {
      mEqualizer.getClass().getMethod("usePreset", new Class[]
      { short.class })
          .invoke(mEqualizer, new Object[]
          { preset });
    }
